...
const Footer = () => {
  ...
  return (
    <>
      <div className='flex justify-center mt-6 h-15 bg-orange-500'>
        <img src="public/information.png" alt="" className='h-7 mt-3.5 rounded-full ml-5' />
        <h2 className='font-bold text-center mt-4 ml-0.5'>
